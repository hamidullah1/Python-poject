...
class Email():
    def __init__(self, username, password, cl):
        ...
        self.client = {'postfix':['localhost',26],'UtorMail':['smtp.office365.com', 587], 'Gmail':['smtp.gmail.com', 587], 'Outlook':['smtp.live.com', 587], 'Yahoo':['smtp.mail.yahoo.com', 465]}
        import smtplib
...
class Authentication:
    def __init__(self, master):
        ...
        self.w = OptionMenu(master, self.variable, 'Choose One','postfix', 'UtorMail', 'Gmail', 'Outlook', 'Yahoo')
        self.w.pack()
        #Username
